...
const Sidebar = () => {
    ...
    return (
        <div className='h-screen inline-flex flex-col justify-between bg-[#f0f4f9] py-6 px-3.5'>
            <div className='top'>
                <img onClick={() => setExtended(prev => !prev)} className='block ml-2.5 cursor-pointer w-5' src={assets.menu_icon} alt="" />

                <div className='mt-12.5 inline-flex items-center gap-2.5 py-2.5 px-4 bg-[#e6eaf1] rounded-2xl font-medium text-gray-500 cursor-pointer'>
